         ...
         <section className="bg-[#0B3C5D] text-white py-24 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
            <div className="max-w-4xl mx-auto relative z-10">
               ...
               <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <a href="https://wa.me/263779325039?text=Hello" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                     <Button className="w-full bg-[#F5B700] text-[#0B3C5D] hover:bg-yellow-400 gap-2">
                        <MessageCircle size={20} /> Chat on WhatsApp Now
                     </Button>
                  </a>
                  <a href="tel:+263779325039" className="w-full sm:w-auto">
                  ...
                  <Card className="p-8 border-l-4 border-green-500 hover:-translate-y-1 transition-transform">
                     <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                           ...
                           <a href="https://wa.me/263779325039?text=Hello" target="_blank" rel="noopener noreferrer" className="bg-gray-50 border border-gray-100 rounded-xl p-4 flex items-center justify-between hover:bg-gray-100 transition-colors block">
                              <span className="text-xl font-bold text-gray-900">+263 77 932 5039</span>
                  ...
                  <Card className="p-8 border-l-4 border-[#F5B700] hover:-translate-y-1 transition-transform">
                     <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                           ...
                           <a href="tel:+263779325039" className="bg-gray-50 border border-gray-100 rounded-xl p-4 flex items-center justify-between hover:bg-gray-100 transition-colors block">
                              <span className="text-xl font-bold text-gray-900">+263 77 932 5039</span>
